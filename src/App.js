...
import ShowExhibitions from './components/exhibitions/ShowExhibitions'
...
import OwnersExhibitions from './components/exhibitions/OwnersExhibitions';
			...
			<Fragment>
				...
				<Routes>
					...
					<Route
						...
						<Route
								path='/exhibitions/:id'
								element={<ShowExhibitions msgAlert={msgAlert} user={user} />}
							/>
							<Route
								path='/exhibitions/user/:ownerId'
								element={<OwnersExhibitions user={user} />}
							/>
						<Route
							path='/exhibitions/mine'
							element={
								<RequireAuth user={user}>
									<MyExhibitions msgAlert={msgAlert} user={user} />
								</RequireAuth>}
						/>
